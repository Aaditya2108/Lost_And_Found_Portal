    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('LOST', 'Lost'), ('FOUND', 'Found'), ('RESOLVED', 'Resolved')], max_length=10)),
                ...
                ('location', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='items.location')),
            ],
        ),
    ]
